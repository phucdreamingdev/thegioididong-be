...
public class AdminController {
	...
	@GetMapping("/update-order-by-id")
	public boolean updateMemberOrderStatusById(Long memberOrderId, String status) {
		return adminService.updateOrderStatusByMemberOrderId(memberOrderId, status);
	}
}
